<?php get_header(); ?>
  ...
  $imagenB =wp_get_attachment_image_src( $imagen,'full');
  ?>


    <div class="hero" style="background-image:url(<?php echo $imagenB[0]; ?>)">
      ...
      <div class="	principal contenedor">
            <div class="contenedor-grid">
                ...
                <?php 	while(have_posts()): the_post(); ?>
                        ...
                        <a href="<?php the_permalink(); ?>"><?php the_post_thumbnail('articulos'); ?></a>
