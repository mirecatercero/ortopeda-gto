...
class WPZoom_Featured_Products extends WP_Widget {
    ...
    function __construct() {
        /* Widget settings. */
        $widget_ops = array( 'classname' => 'wpzoom-featured-products', 'description' => __('Custom WPZOOM widget that displays featured WooCommerce products', 'wpzoom') );

        /* Widget control settings. */
        $control_ops = array( 'id_base' => 'wpzoom-featured-products' );

        /* Create the widget. */
        parent::__construct( 'wpzoom-featured-products', __('WPZOOM: Featured WooCommerce Products', 'wpzoom'), $widget_ops, $control_ops );
    }
